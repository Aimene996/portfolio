...
export const projects: Project[] = [
  ...
  {
    id: 6,
    title: 'ConGeo - Leave Management Platform',
    shortDescription: 'Enterprise leave and time-off management with admin dashboards, team lead workflows, employee directory, holiday calendars, and bilingual EN/FR support.',
    fullDescription: 'ConGeo is a full-featured leave management platform for organizations that need to handle vacation requests, approvals, and workforce planning in one place. Administrators manage leave requests, employee records, organization structure, public holidays, and CSV time-import workflows. Team leads (chefs de service) review team requests, manage their squad, and submit their own leave. The app ships with role-based access, a polished public landing page, and live dashboards in English and French. Deployed at congeo.vercel.app with demo flows documented end-to-end for admin and manager roles.',
    thumbnail: '/congeo/04-admin-dashboard.png',
    images: [
      '/congeo/01-homepage.png',
      '/congeo/04-admin-dashboard.png',
      '/congeo/05-admin-requests.png',
      '/congeo/06-admin-employees.png',
      '/congeo/08-admin-holidays.png',
      '/congeo/11-admin-dashboard-fr.png',
      '/congeo/15-chef-dashboard.png',
      '/congeo/16-chef-demandes.png',
      '/congeo/20-chef-demander-conge.png',
      '/congeo/stitch-00-home.png',
    ],
    link: 'https://congeo.vercel.app/',
    githubLink: 'https://github.com/Aimene996',
    tags: ['Next.js', 'TypeScript', 'HR', 'Leave Management', 'Bilingual', 'SaaS'],
    features: [
      'Admin Dashboard & Analytics',
      'Leave Request Creation & Approval',
      'Employee Directory & Organization Setup',
      'Public Holiday Calendar',
      'CSV Time Attendance Import',
      'Team Lead (Chef de Service) Role',
      'Team Assignment & Squad Management',
  ...
  {
    id: 7,
    title: 'EFive - Barber Shop Platform',
    ...
    fullDescription: 'EFive is a modern salon platform built for premium barbershops. The site invites customers to book appointments, browse a curated portfolio of hair and beard work, discover events, and shop grooming products from an integrated boutique. A clean landing experience highlights the brand story, while filtered portfolio galleries showcase expertise across hair and beard styles. The platform includes user authentication, multi-language support (French), and responsive design optimized for mobile booking flows. Live at efive-eight.vercel.app.',
